...
systemDictionary = {
    ...
    'adapter-description': {
        "The adapter downloads prices of currencies in the configured update interval. If you configure an API Key and the corresponding secret, it will pull account balances as well. You may create an API Key on binance.com - i suggest to restrict it to \"read-only": {
